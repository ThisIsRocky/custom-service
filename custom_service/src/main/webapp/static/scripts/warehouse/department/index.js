var userFacade = {
    ...
    loadDetails : function(params) {
        ...
        var url = '/system/user/warehouse/list';
            ...
            _this.detailsGrid = $(grid_selector).jqGrid({
                ...
                colModel : [ {
                    ...
                    formatter : function(cellvalue, options, rowObject) {
                        var retVal = '<a class="zs-auth btn btn-mini btn-white btn-default btn-bold fa fa-minus-square-o btn-delete" href="javascript:void(0);" user_id='+rowObject.userId+' permission="/system/user/warehouse/delete">删除</a>';
                        //var retVal = '修改，删除';
                        return retVal;
                    }
                }],
            ...
            _this.detailsGrid = $(grid_selector).jqGrid({
                ...
                colModel : [{
                    ...
                    formatter : function(cellvalue, options, rowObject) {
                        ...
                        var retVal = '<a class="zs-auth btn btn-mini btn-white btn-default btn-bold fa '+clz+'" href="javascript:void(0);" user_id='+rowObject.userId+' permission="/system/user/warehouse/suspend"></a>';
                        retVal += '<a class="zs-auth btn btn-mini btn-white btn-default btn-bold fa fa-minus-square-o btn-delete" href="javascript:void(0);" user_id='+rowObject.userId+' permission="/system/user/warehouse/delete">删除</a>';
                        retVal += '<a class="zs-auth btn btn-mini btn-white btn-default btn-bold fa fa-group btn-role" href="javascript:void(0);" onclick="$.showCommonEditDialog(\'/warehouse/department/addRole?userId='+rowObject.userId+'\',\'角色设置\',400,200);" permission="/warehouse/department/addRole">角色设置</a>';
                        //var retVal = '修改，删除';
                        return retVal;
                    }
                }],
...
$(document).on('click', '.btn-suspend', function(event) {
    ...
    $.ajax({
            type: 'post',
            url: '/system/user/warehouse/suspend',
            data: {
                userId:userId
            },
            dataType: "json",
...
$(document).on('click', '.btn-active', function(event) {
    ...
    $.ajax({
            type: 'post',
            url: '/system/user/warehouse/active',
            data: {
                userId:userId
            },
            dataType: "json",
...
$(document).on('click', '.btn-delete', function(event) {
    ...
    $.ajax({
            type: 'post',
            url: '/system/user/warehouse/delete',
            data: {
                userId:userId
            },
            dataType: "json",
