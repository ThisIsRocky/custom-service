...
import me.ele.cs.push.codec.MessageProtobufDecoderFactory;
import me.ele.cs.push.protobuf.IMMessage;
import me.ele.cs.push.util.MessageObjectKeyGen;

import java.util.HashMap;
import java.util.Map;

/**
 * Created by iser on 16/5/23.
 */
public class MessageServerInitializer extends ChannelInitializer<Channel> {
    ...
    protected void initChannel(Channel ch) throws Exception {
        ...
        pipeline.addLast("decoder", new MessageProtobufDecoderFactory());
